...
#OAR -O test_cudnn.out
#OAR -E test_cudnn.err
#OAR -t devel
set -e
...
python -c "import torch; import torch.nn as nn; conv = nn.Conv1d(1, 1, 3).cuda(); x = torch.randn(1, 1, 10).cuda(); print(conv(x).shape); print('SUCCESS')"
